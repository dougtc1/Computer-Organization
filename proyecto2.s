...
y:		.asciiz " y "
trancado:	.asciiz "La ronda se tranco. \n"
puntuacionRonda: .ascii "La puntacion actual es: \n"
equipo:		.asciiz "Equipo "
es:		.asciiz " es: "
nuevaRonda:	.asciiz "Comienza una nueva ronda. \n"
...
InicializacionJuego:
	...
	move $t2, $v0 # Se asigna la direccion del jugador 2 al registro $t2
	...
	move $t3, $v0 # Se asigna la direccion del jugador 3 al registro $t3
	...
	move $t4, $v0 # Se asigna la direccion del jugador 4 al registro $t4
...
imprimirTablero:
	...
	# $s0: Contiene la direccion de la ficha mas a la izquierda del tablero 
	# $s2: Carga la direccion de la siguiente ficha
...
empilarTodas:
	...
	# $s1: Direccion del jugador que juega el primer turno
...
tranca:
	...
	# En caso de empate en la tranca, nadie recibe puntos y se comienza una nueva ronda
...
cambioDeRonda:
	...
	imprimir_t(puntuacionRonda)
	
	# Se imprime la puntuacion del equipo Impar
	...
	# Se imprime la puntuacion del equipo Par
	...
	# Darle fichas al jugador 1
	move $a0, $t0
	move $a1, $t1
	
	jal Fichas
	
	#Darle fichas al jugador 2
