...
# $s6: Codigo ascii de cada letra en la palabra "Time: "
...
# mensj: Palabra "Time", para imprimir por la consola de MARS
# aux1 y aux2 Sirven para guardar valores que se puedan necesitar en el programa principal al salir del manejador
